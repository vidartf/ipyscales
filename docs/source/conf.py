...
# -*- coding: utf-8 -*-
#
# ipyscales documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyscales', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyscalesdoc'
...
latex_documents = [
    (master_doc, 'ipyscales.tex', 'ipyscales Documentation',
...
if not on_rtd:
    # Don't minify if local:
    jupyter_sphinx_require_url = 'https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.4/require.js'
